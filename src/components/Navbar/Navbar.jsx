      ...
      <div className="flex flex-row sticky top-0 z-[99999]">
        <div className="w-8 bg-white hidden md:block">
          <img
            ...
            src={logo}
            alt="logo"
            className="w-16 h-16 rounded-full bg-white absolute cursor-pointer"
          />
        </div>
        <div className="navbar bg-[#F8E8EE] ">
          <div className="navbar-start md:ml-8">
            <div className="hidden lg:flex flex-row gap-10 items-center mx-4 ">
              <Link to={`/category/clothing`} className="text-lg quicksand-500">
                Clothing
              </Link>
              <Link to={`/category/shoes`} className="text-lg quicksand-500">
                Shoes
              </Link>
              <Link
                to={`/category/equipment`}
                className="text-lg quicksand-500"
              >
                Equipment
              </Link>
            </div>
            <div className="dropdown lg:hidden block">
              ...
              >
                <li>
                  <Link to={`/`} className="text-lg quicksand-500">
                    Home
                  </Link>
                </li>
                <li>
                ...
                <div className="dropdown dropdown-end">
                  ...
                  >
                    <div className="indicator">
                      ...
                      {user.cart.count > 0 && (
                        <span className="badge badge-sm indicator-item quicksand-500">
                          {user.cart.count > 99 ? "99+" : user.cart.count}
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  >
                    <div className="card-body">
                      <span className="text-lg font-bold quicksand-500">
                        {user.cart.count}{" "}
                        {user.cart.count > 1 ? "Items" : "Item"}
                      </span>
                      <span className="text-sm text-info quicksand-500">
                        Subtotal: {user.cart.total_price.toLocaleString()} THB
                      </span>
                      <div className="card-actions">
                        <button
                          onClick={(e) => navigate(`/cart`)}
                          className="btn btn-primary btn-block quicksand-500"
                        >
                          View cart
                        </button>
                      </div>
              ...
              <>
                {user.loading ? (
                  ...
                  <div className="flex flex-row gap-10 items-center">
                    <Link to={`/login`} className="text-lg quicksand-500 ">
                      Login
                    </Link>
                    <Link
                      to={`/register`}
                      className="hidden sm:block text-lg quicksand-500 "
                    >
                      Register
                    </Link>
                  </div>
